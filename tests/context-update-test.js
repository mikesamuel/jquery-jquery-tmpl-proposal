...
function testPcdata() {
	...
	assertTransition( "HTML_PCDATA", "<sTyLe type='text/css'", "HTML_TAG STYLE" );
	assertTransition(
			"HTML_PCDATA", "<textarea name='text'", "HTML_TAG TEXTAREA" );
	...
	assertTransition(
			...
			"HTML_BEFORE_ATTRIBUTE_VALUE NORMAL SCRIPT" );
	assertTransition(
			"HTML_PCDATA", "<input type=button value=>", "HTML_PCDATA" );
}
...
function testCssUri() {
	...
	assertTransition(
			"CSS_URI START", "/search?q=cute+bunnies", "CSS_URI QUERY" );
	...
	assertTransition(
			"CSS_DQ_URI START", "/don't+panic", "CSS_DQ_URI PRE_QUERY" );
...
function testJsLineComment() {
	...
	assertTransition(
			"JS_LINE_COMMENT DIV_OP", "\"'/", "JS_LINE_COMMENT DIV_OP" );
...
function testJsBlockComment() {
	...
	assertTransition( "JS_BLOCK_COMMENT REGEX", "Hello, World!",
									 "JS_BLOCK_COMMENT REGEX" );
	assertTransition(
			"JS_BLOCK_COMMENT REGEX", "\"'/", "JS_BLOCK_COMMENT REGEX" );
