...
function testFilterCssValue() {
  ...
  assertEquals("zSafehtmlz", filterCssValue("</style><script>alert('foo')</script>/*"));
...
function testFilterHtmlAttribute() {
  ...
  assertEquals("zSafehtmlz", filterHtmlAttribute("><script>alert('foo')</script"));
...
function testFilterHtmlElementName() {
  ...
  assertEquals("zSafehtmlz", filterHtmlElementName("SCRIPT"));
  assertEquals("zSafehtmlz", filterHtmlElementName("><script>alert('foo')</script"));
...
function testNormalizeUriAndFilterNormalizeUri() {
  ...
  assertEquals("#zSafehtmlz", filterNormalizeUri("data:text/javascript,alert%281337%29"));
  ...
  assertEquals("#zSafehtmlz", filterNormalizeUri("jav\tascript:alert('XSS');"));
  assertEquals("#zSafehtmlz", filterNormalizeUri("jav&#x09;ascript:alert('XSS');"));
  assertEquals("#zSafehtmlz", filterNormalizeUri("jav&#x0A;ascript:alert('XSS');"));
  assertEquals("#zSafehtmlz", filterNormalizeUri("jav&#x0D;ascript:alert('XSS');"));
  assertEquals(
      "#zSafehtmlz",
      filterNormalizeUri(
          "\nj\n\na\nv\na\ns\nc\nr\ni\np\nt\n:\na\nl\ne\nr\nt\n(\n1\n3\n3\n7\n)"));
  assertEquals("#zSafehtmlz", filterNormalizeUri("\u000e  javascript:alert('XSS');"));
